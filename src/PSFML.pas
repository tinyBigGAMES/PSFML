...
var
  ...
  function da0443d3909e434abce4e17029ad70aa(): string;
  const
    CValue = '3fb596e25cea4f05818af062e33898c9';
  begin
    Result := CValue;
  end;
...
begin
  ...
  if not Boolean((FindResource(HInstance, PChar(da0443d3909e434abce4e17029ad70aa()), RT_RCDATA) <> 0)) then AbortDLL();
  LResStream := TResourceStream.Create(HInstance, da0443d3909e434abce4e17029ad70aa(), RT_RCDATA);
  try
